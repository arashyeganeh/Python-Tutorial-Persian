...
برای تبدیل string به int، باید شرایط ذیل فراهم باشد:

 💡 **1. مقدار string باید فقط و فقط عددی صحیح  باشد.**
...
💡 **2. نمی توانیم از e ( Exponential Notation )  در رشته استفاده کنیم.**
