...
برای تبدیل string به float، باید شرایط ذیل فراهم باشد:
 ...
 💡 **1. مقدار string باید فقط و فقط عددی صحیح ( int ) یا اعشاری ( float ) باشد.**
...
برای تبدیل string به float، باید شرایط ذیل فراهم باشد:
 ...
 💡 **1. مقدار string باید فقط و فقط عددی اعشاری یا float باشد.**
...
### 7. تبدیل به دیکشنری با متد ()dict
...
### 8. تبدیل به کد ASCII با متد ()ord
...
### 9. تبدیل عدد صحیح به مبنای 16 با متد ()hex
...
### 10. تبدیل عدد صحیح به مبنای 8 با متد ()oct
...
### 11. تبدیل عدد صحیح به باینری با متد ()bin
